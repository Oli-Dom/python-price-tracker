Project: Web Scraper (Requests + BeautifulSoup)

Exploring the fundamentals of web scraping and data extraction using Python.
Features to Implement

    [ ] Infinite Loop: Wrap the execution in a while True loop and implement time.sleep() to prevent rate-limiting.
